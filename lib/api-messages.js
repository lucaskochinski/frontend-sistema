...
const MAP = {
  ...
  subscription_not_found: "Nenhuma subscrição activa encontrada.",
  subscription_not_active: "A subscrição não está activa — não é possível cancelar.",
  ...
  integrations_body_invalid: "Corpo do pedido inválido.",
  integrations_empty_patch: "Indique pelo menos um campo para actualizar.",
};
